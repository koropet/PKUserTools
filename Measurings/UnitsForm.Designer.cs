...
namespace PKUserTools.Measurings
{
	partial class UnitsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Единицы модели";
			// 
			// label2
			// 
			...
			this.label2.Text = "Елиницы измерения";
			// 
			// comboBox1
			// 
			...
			this.comboBox2.Location = new System.Drawing.Point(141, 45);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.UnitsFormFormClosing);
